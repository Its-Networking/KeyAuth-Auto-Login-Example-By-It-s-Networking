...
namespace KeyAuth
{
    public class api
    {
        ...
        public api(string name, string ownerid, string secret, string version)
        {
            ...
            {
                var res = MessageBox.Show("Application is not yet setup. \n \n Make sure you open the .sln and go to LoginForm.cs and enter the following: \n \n app name, \n secret, \n ownerID, \n version,", "You forgot something", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Environment.Exit(0);
            }
